...
- **Mention specific technical indicators** (RSI, MACD, Bollinger Bands, moving averages, etc.)

### ⚠️ Technical Analysis Rule

**Warp Capital не использует традиционный теханализ. Фокус на on-chain данных.**

```yaml
# ❌ WRONG - specific technical indicators
- "RSI находится в зоне перепроданности"
- "Цена ниже 200-дневной скользящей средней"
- "Болинджер-бенды сжаты до минимума"
- "MACD показывает медвежий crossover"

# ✅ OK - aggregated technical sentiment
- "27 из 30 технических сигналов негативные"
- "Технические индикаторы преимущественно медвежьи"
- "Большинство осцилляторов в зоне перепроданности"

# ✅ CORRECT - on-chain metrics (our focus!)
- "LTH MVRV 2.37 — в нормальной зоне"
- "STH NUPL -3.5% — зона Hope/Fear"
- "Realized Price $39k — цена в 2.4x выше себестоимости"
```

**Исключения:**
- Fear & Greed Index — допустим как индикатор настроений
- Цена относительно ATH — не теханализ, просто факт
- Aggregate scores ("X из Y сигналов") — допустимы
